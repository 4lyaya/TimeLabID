...
@section('title', 'Jadwal Jurusan - ' . $department->name)

@section('content')
    <h2 class="text-2xl font-bold mb-4 text-primary">Jadwal Jurusan: {{ $department->name }}</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        @empty
            <p class="text-gray-500">Tidak ada jadwal untuk jurusan ini.</p>
        @endforelse
    </div>
@endsection
